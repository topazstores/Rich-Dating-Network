...
check(version_compare(phpversion(), '7.0', '>='), sprintf('Checking that PHP version (%s installed)', phpversion()), 'Install PHP 7.x or newer (current version is '.phpversion(), true);
