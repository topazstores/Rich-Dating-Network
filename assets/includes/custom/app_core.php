<?php
if($sm['plugins']['settings']['forceSSL'] == 'No'){
	$newSiteUrl = str_replace('https://','http://', $sm['config']['site_url']);
	$sm['config']['site_url'] = $newSiteUrl;
	$sm['config']['admin_url'] = $newSiteUrl . 'administrator';
	$sm['config']['theme_url'] = $newSiteUrl . 'themes/' . $sm['config']['theme'];
	$sm['config']['theme_url_landing'] = $newSiteUrl . 'themes/' . $sm['config']['theme_landing'];
	$sm['config']['theme_url_mobile'] = $newSiteUrl . 'themes/' . $sm['config']['theme_mobile'];
	$sm['config']['theme_url_email'] = $newSiteUrl . 'themes/' . $sm['config']['theme_email'];
	$sm['config']['ajax_path'] = $newSiteUrl . 'requests';
